...
#Ruby code construction
# Local Variables - Can begin with small case or underscore
_local_var, local_5var, _Local_v, _45 = 5, 6, 7, 45

# Instance Variables - Begins with @ next character can be small or capital bur not a digit
@New_x, @x_new, @v5x, @_new = 8, 9, 0, 10

#Class Variables - Begins with @@ sign
class One
  @@new_x, @@_new5 = 3,1
end

# Global variables - Begin with a $ sign
$newq, $_fla = 1,2

# Constant - Begin with an upcase letter
New_var, NEW_FILE = 5, 6

# Method names follow local variable constructs but can end with ?, ! or =
# my_new_func, new_func5?, _new_func!
